    ...
    <div className="w-full max-w-3xl mx-auto flex items-center justify-between">
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          >
            <Dialog.Close
              className="absolute right-6 top-6 text-zinc-400 rounded-lg hover:text-zinc-200 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-zinc-900"
            >
